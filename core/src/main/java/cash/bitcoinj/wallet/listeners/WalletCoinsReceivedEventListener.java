...
public interface WalletCoinsReceivedEventListener {
     ...
     * transaction receives its first confirmation, register a {@link cash.bitcoinj.core.TransactionConfidence} event listener using
     * the object retrieved via {@link cash.bitcoinj.core.Transaction#getConfidence()}. It's safe to modify the
