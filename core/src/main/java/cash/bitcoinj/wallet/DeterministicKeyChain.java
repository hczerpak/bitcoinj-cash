 ...
 * {@link cash.bitcoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link cash.bitcoinj.crypto.MnemonicCode},
 ...
 * {@link cash.bitcoinj.crypto.DeterministicKey#serializePubB58(cash.bitcoinj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link cash.bitcoinj.crypto.DeterministicKey#deserializeB58(cash.bitcoinj.crypto.DeterministicKey, String, cash.bitcoinj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(cash.bitcoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link cash.bitcoinj.crypto.DeterministicHierarchy} and
 * {@link cash.bitcoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(cash.bitcoinj.crypto.DeterministicKey)}
     ...
     * @see cash.bitcoinj.wallet.MarriedKeyChain
     */
