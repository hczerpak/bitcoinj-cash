...
/**
 * <p>A KeyChainGroup is used by the {@link cash.bitcoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws cash.bitcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link cash.bitcoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws cash.bitcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
