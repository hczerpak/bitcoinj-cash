...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link cash.bitcoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws cash.bitcoinj.crypto.MnemonicException if check fails
     */
