...
import cash.bitcoinj.script.*;
import cash.bitcoinj.signers.*;
import cash.bitcoinj.utils.*;
import cash.bitcoinj.wallet.Protos.Wallet.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, cash.bitcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link cash.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(cash.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link cash.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(cash.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(cash.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link cash.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link cash.bitcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link cash.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(cash.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link cash.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(cash.bitcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(cash.bitcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link cash.bitcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, cash.bitcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link cash.bitcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link cash.bitcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link cash.bitcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws cash.bitcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(cash.bitcoinj.crypto.KeyCrypter,
     ...
     * {@link cash.bitcoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link cash.bitcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link cash.bitcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link cash.bitcoinj.signers.TransactionSigner.MissingSignatureException}
         * will be thrown for P2SH and {@link cash.bitcoinj.core.ECKey.MissingPrivateKeyException} for other tx types.
         */
        THROW
    }
     ...
     */
    public void setTransactionBroadcaster(@Nullable cash.bitcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws cash.bitcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
