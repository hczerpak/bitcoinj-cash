...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link cash.bitcoinj.wallet.Wallet}. Key chains
...
public interface KeyChain {
     ...
     *
     * <p>See the docs for {@link cash.bitcoinj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
