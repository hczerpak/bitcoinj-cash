...
import cash.bitcoin.protocols.payments.Protos.PaymentDetails;
...
import cash.bitcoinj.wallet.KeyChain.KeyPurpose;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link cash.bitcoinj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link cash.bitcoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
