...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws cash.bitcoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws cash.bitcoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(cash.bitcoinj.crypto.KeyCrypter,
