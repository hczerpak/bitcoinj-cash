 ...
 * <li>A url where the {@link cash.bitcoin.protocols.payments.Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link cash.bitcoin.protocols.payments.Protos.PaymentRequest} object</li>
 * </ul>
 *
 ...
 *
 * <p>Call sendPayment with a list of transactions that will be broadcast. A {@link cash.bitcoin.protocols.payments.Protos.Payment} message will be sent
 ...
 * {@link cash.bitcoin.protocols.payments.Protos.PaymentACK} is received from the merchant. Typically a wallet will show the message to the user
...
public class PaymentSession {
     ...
     * uri is a BIP-72-style BitcoinURI object that specifies where the {@link cash.bitcoin.protocols.payments.Protos.PaymentRequest} object may
     ...
     * url is an address where the {@link cash.bitcoin.protocols.payments.Protos.PaymentRequest} object may be fetched.
     * If verifyPki is specified and the payment request object specifies a PKI method, then the system trust store will
     * be used to verify the signature provided by the payment request. An exception is thrown by the future if the
     * signature cannot be verified.
     */
    ...
    /**
     * Creates a PaymentSession from the provided {@link cash.bitcoin.protocols.payments.Protos.PaymentRequest}.
