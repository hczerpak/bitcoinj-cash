 ...
 *
 * @see cash.bitcoinj.core.NetworkParameters#getMajorityWindow()
 * @see cash.bitcoinj.core.NetworkParameters#getMajorityEnforceBlockUpgrade()
 * @see cash.bitcoinj.core.NetworkParameters#getMajorityRejectBlockOutdated()
 */
