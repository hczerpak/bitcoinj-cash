...
import cash.bitcoinj.utils.BtcAutoFormat.Style;
import static cash.bitcoinj.utils.BtcAutoFormat.Style.*;
 ...
 * method.  This argument can be either a {@link cash.bitcoinj.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    /**
      ...
      * {@link cash.bitcoinj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
