...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link cash.bitcoinj.store.SPVBlockStore} or you could also try a
     * {@link cash.bitcoinj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
