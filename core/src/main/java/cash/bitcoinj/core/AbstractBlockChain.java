 ...
 * the lightweight SPV mode, a {@link cash.bitcoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link cash.bitcoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
