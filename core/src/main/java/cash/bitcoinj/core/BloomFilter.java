...
public class BloomFilter extends Message {
     ...
     * See {@link cash.bitcoinj.core.BloomFilter.BloomUpdate} for a brief description of each mode. The purpose
    ...
    /**
     * Returns true if this filter will match anything. See {@link cash.bitcoinj.core.BloomFilter#setMatchAll()}
