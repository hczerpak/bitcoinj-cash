...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * {@link cash.bitcoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link cash.bitcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link cash.bitcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link cash.bitcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link cash.bitcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link cash.bitcoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link cash.bitcoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link cash.bitcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link cash.bitcoinj.core.Peer#ping()}.
     */
