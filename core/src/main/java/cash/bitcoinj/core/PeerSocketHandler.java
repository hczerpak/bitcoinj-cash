...
import cash.bitcoinj.net.MessageWriteTarget;
 ...
 * {@link cash.bitcoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link cash.bitcoinj.net.NioClient} or
     * {@link cash.bitcoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
