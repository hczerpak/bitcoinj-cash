...
public class Context {
     ...
     * @param feePerKb The default fee per 1000 bytes of transaction data to pay when completing transactions. For details, see {@link cash.bitcoinj.wallet.SendRequest#feePerKb}.
     * @param ensureMinRequiredFee Whether to ensure the minimum required fee by default when completing transactions. For details, see {@link cash.bitcoinj.wallet.SendRequest#ensureMinRequiredFee}.
     */
    ...
    /**
     * Require that new threads use {@link #propagate(Context)} or {@link cash.bitcoinj.utils.ContextPropagatingThreadFactory},
     ...
     * a {@link cash.bitcoinj.utils.ContextPropagatingThreadFactory}.
     */
    ...
    /**
     * Returns the {@link cash.bitcoinj.core.NetworkParameters} specified when this context was (auto) created. The
    ...
    /**
     * The default fee per 1000 bytes of transaction data to pay when completing transactions. For details, see {@link cash.bitcoinj.wallet.SendRequest#feePerKb}.
     */
    ...
    /**
     * Whether to ensure the minimum required fee by default when completing transactions. For details, see {@link cash.bitcoinj.wallet.SendRequest#ensureMinRequiredFee}.
     */
