 ...
 * {@link cash.bitcoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link cash.bitcoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link cash.bitcoinj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link cash.bitcoinj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link cash.bitcoinj.core.TxConfidenceTable}
     ...
     * Once the pong is received the value returned by {@link cash.bitcoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link cash.bitcoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link cash.bitcoinj.core.Peer#ping()} has never
