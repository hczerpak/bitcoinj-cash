 ...
 *
 * <p>TransactionConfidence is updated via the {@link cash.bitcoinj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link cash.bitcoinj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link cash.bitcoinj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link cash.bitcoinj.core.TransactionConfidence#getConfidenceType()}
     ...
     * {@link cash.bitcoinj.core.listeners.BlockChainListener}, attach it to a {@link BlockChain} and then use the getters on the
     ...
     * and so on. This information is useful for {@link cash.bitcoinj.wallet.CoinSelector} implementations to risk analyze
