...
/**
 * <p>A reusable object that will calculate, given a list of {@link cash.bitcoinj.core.PeerFilterProvider}s, a merged
 * {@link cash.bitcoinj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link cash.bitcoinj.core.PeerGroup} class internally.</p>
 *
