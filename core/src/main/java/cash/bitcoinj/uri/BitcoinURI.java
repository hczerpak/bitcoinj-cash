...
public class BitcoinURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link cash.bitcoinj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link cash.bitcoinj.core.NetworkParameters#getUriScheme} to get the scheme
