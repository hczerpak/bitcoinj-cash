...
public abstract class DatabaseFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    /**
     * Create a new store for the given {@link cash.bitcoinj.core.NetworkParameters}.
     ...
     *
     * <p>The balance {@link cash.bitcoinj.store.DatabaseFullPrunedBlockStore#getBalanceSelectSQL()} returns
