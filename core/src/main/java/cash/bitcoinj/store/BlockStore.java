...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link cash.bitcoinj.core.BlockChain#getChainHead()}
     * or perhaps {@link cash.bitcoinj.core.BlockChain#getBestChainHeight()} which will run in constant time and
    ...
    /**
     * Get the {@link cash.bitcoinj.core.NetworkParameters} of this store.
