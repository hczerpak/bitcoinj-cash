...
import static cash.bitcoinj.core.Coin.*;
import static cash.bitcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static cash.bitcoinj.testing.FakeTxBuilder.createFakeBlock;
import static cash.bitcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        cash.bitcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
